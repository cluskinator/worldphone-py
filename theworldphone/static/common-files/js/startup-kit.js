...
$(function () {
    $('.page-wrapper, .navbar-fixed-top, .navbar-collapse a:not(.dropdown-toggle), .navbar-collapse button, .navbar-collapse input[type=submit]').on('click', function(e) {
        console.log(this);
        if($('html').hasClass('nav-visible')) {
            console.log('I got here cause you clicked a button in the nav');
            setTimeout(function(){
...
startupKit.uiKitHeader._inFixedMode = function(headerClass) {
    ...
    if ($(headerClass + ' .navbar').hasClass('foo')) {
